...
ggplot(tit_sur, aes(x=Class, y=perc, fill=Class)) + geom_bar(stat="identity")
...
ggplot(tit_sex, aes(x=Class, y=perc, fill=Sex)) +
geom_col(position = "dodge") + ggtitle("Survivor Rate")


ggplot(tit_sex, aes(x=Class, y=perc, group=Sex, color=Sex)) +
